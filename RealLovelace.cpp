...
long long int RealLovelace::getExpoente()
{
	return expoente;
}
...
RealLovelace & RealLovelace::somar(const RealLovelace B)
{

}
RealLovelace & RealLovelace::subtrair(RealLovelace B)
{

}
RealLovelace & RealLovelace::multiplicar(RealLovelace B)
{

}
RealLovelace & RealLovelace::dividir(RealLovelace B)
{

}
RealLovelace & RealLovelace::Inversao()
{

}
RealLovelace & RealLovelace::Exponenciacao(RealLovelace X)
{

}
void RealLovelace::imprimir()
{
